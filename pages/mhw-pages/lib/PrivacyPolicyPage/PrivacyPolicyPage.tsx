  ...
  return (
    <div className="flex flex-col w-full items-center">
      <div className="flex flex-col justify-center max-w-sm bg-base-100 prose p-2">
        ...
        <p>
          Since we do not collect any information about you, it follows that we
          do not use your information in any way. Your privacy is of utmost
        ...
        <p>
          ...
          any information that could potentially identify you. Your trust in us
          is important, and we aim to protect your privacy at all times.
        </p>
        <p>
