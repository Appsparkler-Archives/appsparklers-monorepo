  ...
  return (
    <div className="flex flex-col justify-center max-w-sm bg-base-100 prose p-2">
      ...
      <p>
        ...
        use, and safeguard your personal information, or rather, the lack
        thereof.
      </p>
      <h2>We Do Not Collect Your Data</h2>
      <p>
        We want you to feel comfortable and safe while using our app. To ensure
        your privacy and security, we want to make it clear that:
      </p>
      <ul>
      ...
      <p>
        Since we do not collect any information about you, it follows that we do
        not use your information in any way. Your privacy is of utmost
      ...
      <p>
        ...
        intention of sharing it with anyone. We do not sell, trade, or share any
        information that could potentially identify you. Your trust in us is
        important, and we aim to protect your privacy at all times.
      </p>
      <p>
